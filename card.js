...
<div class="card-inner">
    <div class="card-front">
       <img src="/cardse/card-JackClubs.png" alt="is wiram k lie khed h hme">
    </div>
    <div class="card-back">
         <img src="/cardse/card-back-Blue.png" alt="" class="">
    </div>
</div>
</div> }*/
const cardObjectDefinitions = [
   {id:1, imagePath:'card-KingHearts.jpg'},
   {id:2, imagePath:'card-JackClubs.jpg'},
   {id:3, imagePath:'card-QueenDiamonds.jpg'},
   {id:4, imagePath:'card-AceSpades.jpg'}
]
...
function gameOver()
{
    ...
    const gameOverMessage = `Game Over Dear! Final Score - <span class = 'badge'>${score}</span> Click 'Play Game' button to play again`
...
function cardFlyInEffect()
{
    ...
    function flyIn()
    {
        ...
        if(count == 1 || count == 200 || count == 400 || count == 600)
        {
            cardCount++
...
// to add the card to each cell means 4 blocks
